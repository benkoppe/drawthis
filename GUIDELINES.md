...
Use modern, best-practice features, and don't be afraid to use experimental ones when they lead to better design. This includes, but isn't limited to, async support and remote functions.

## Database

- This only applies if a database is actually used.
